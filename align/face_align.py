...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help = "specify your source dir", default = "/home/data/CASIA/CASIA-WebFace", type = str)
    parser.add_argument("-dest_root", "--dest_root", help = "specify your destination dir", default = "/home/data/CASIA/CASIA-WebFace-Aligned", type = str)
    ...
    for subfolder in tqdm(os.listdir(source_root)):
        ...
        for image_name in os.listdir(os.path.join(source_root, subfolder)):
            ...
            try: # Handle exception
                ...
                print("{} is discarded due to exception - {}!".format(os.path.join(source_root, subfolder, image_name), e))
                continue
