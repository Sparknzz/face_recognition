...
# general
parser.add_argument('--data-dir', default='/home/data/lfw-align-128', help='')
parser.add_argument('--image-size', type=str, default='112,112', help='')
parser.add_argument('--output', default='/root/face_recognition/data/eval/lfw.bin', help='path to save.')
